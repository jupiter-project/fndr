      ...
      let updatedConfig = await inquirer.prompt([
        {
          ...
          type: 'input',
          default: currentConfig.jupiterServer || 'https://nodes.jup.io',
        },
        {
          name: 'fundedAddress',
          message: `Your funded 'JUP-XXX' address that we'll use to transact and add encrypted account information to the Jupiter blockchain.`,
          type: 'input',
          default: currentConfig.fundedAddress || '',
        },
        {
          name: 'fundedAddressPassphrase',
          message: `Your funded 'JUP-XXX' address passphrase. This is needed to allow funding your fndr address that stores your accounts.`,
          type: 'password',
